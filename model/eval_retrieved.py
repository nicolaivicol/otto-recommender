...
# V.1.0.0
# ┌────────┬───────────┬────────────┬────────────┬────────────┐
# │ type   ┆ recall@20 ┆ recall@100 ┆ recall@200 ┆ recall@max │
# │ ---    ┆ ---       ┆ ---        ┆ ---        ┆ ---        │
# │ str    ┆ f64       ┆ f64        ┆ f64        ┆ f64        │
# ╞════════╪═══════════╪════════════╪════════════╪════════════╡
# │ clicks ┆ 0.550825  ┆ 0.550825   ┆ 0.550825   ┆ 0.550825   │
# │ carts  ┆ 0.494018  ┆ 0.490979   ┆ 0.490979   ┆ 0.490979   │
# │ orders ┆ 0.704218  ┆ 0.702852   ┆ 0.702852   ┆ 0.702852   │
# │ total  ┆ 0.625819  ┆ 0.624087   ┆ 0.624087   ┆ 0.624087   │
# └────────┴───────────┴────────────┴────────────┴────────────┘
